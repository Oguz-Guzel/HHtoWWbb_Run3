...
class DYestimation(NanoBaseHHWWbb):
    ...
    def definePlots(self, tree, noSel, sample=None, sampleCfg=None):
        ...
        skim_vars = {
            "event_no": tree.event,
            "weight": noSel.weight,
            'l1_pt': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].pt, self.tightMuons[0].pt),
            'l2_pt': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].pt, self.tightMuons[1].pt),
            'l1_eta': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].eta, self.tightMuons[0].eta),
            'l2_eta': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].eta, self.tightMuons[1].eta),
            'l1_phi': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].phi, self.tightMuons[0].phi),
            'l2_phi': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].phi, self.tightMuons[1].phi),
            'l1_E': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].p4.E(), self.tightMuons[0].p4.E()),
            'l2_E': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].p4.E(), self.tightMuons[1].p4.E()),
            'l1_px2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].p4.Px(), self.tightMuons[1].p4.Px()),
            'l2_px2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].p4.Px(), self.tightMuons[0].p4.Px()),
            'l1_py2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].p4.Py(), self.tightMuons[1].p4.Py()),
            'l2_py2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].p4.Py(), self.tightMuons[0].p4.Py()),
            'l1_pz2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].p4.Pz(), self.tightMuons[1].p4.Pz()),
            'l2_pz2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].p4.Pz(), self.tightMuons[0].p4.Pz()),
            'l1_E2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[1].p4.E(), self.tightMuons[1].p4.E()),
            'l2_E2': op.switch(op.rng_len(self.tightElectrons) > 1, self.tightElectrons[0].p4.E(), self.tightMuons[0].p4.E()),
            'deltaR': op.switch(
                op.rng_len(self.tightElectrons) > 1,
                op.deltaR(self.tightElectrons[0].p4,
                          self.tightElectrons[1].p4),
                op.deltaR(self.tightMuons[0].p4, self.tightMuons[1].p4)
            ),
            'deltaEta': op.switch(
                op.rng_len(self.tightElectrons) > 1,
                self.tightElectrons[0].eta - self.tightElectrons[1].eta,
                self.tightMuons[0].eta - self.tightMuons[1].eta
            ),
            'deltaPhi': op.switch(
                op.rng_len(self.tightElectrons) > 1,
                op.deltaPhi(
                    self.tightElectrons[0].p4, self.tightElectrons[1].p4),
                op.deltaPhi(self.tightMuons[0].p4, self.tightMuons[1].p4)
            ),
        }

        for sel in Z_peak_selections:
            plots.append(
                Skim(sel.name+'_skim', skim_vars, sel)
            )
